...
if qtd2d == 0:
    print("Nenhum número de 2 digitos (entre -10 e -99), que sejam multiplos de 5 e negativos.")
else:
    lis = lis[:qtd2d]  # Maneira pythônica. Também é possível fazer usando loop 'for' (inverter uma lista usando loop 'for')
    lis.reverse()
    print("Lista com os números digitados entre -10 e -99, multiplos de 5 e negativos: {lis}")
